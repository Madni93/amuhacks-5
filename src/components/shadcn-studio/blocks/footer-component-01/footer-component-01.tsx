...
const Footer = () => {
  ...
  return (
    <footer id='footer'>
      <div className='text-sm mx-auto flex max-w-7xl items justify-between gap-3 p-10 max-md:flex-col sm:px-6 sm:py-6 md:gap-6 md:py-8 jetbrains-mono'>
      ...
      <div className='flex items-center gap-4 justify-center pt-8'>
          ...
          <a href="https://chat.whatsapp.com/EIr56rr5HNV9pwiUQHBMW8">
